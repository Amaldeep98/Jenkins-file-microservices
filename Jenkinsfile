pipeline {
    ...
    environment {
        ...
        SOURCE_IMAGE = "us-central1-docker.pkg.dev/google-samples/microservices-demo/frontend"
        ECR_URI = "183611507646.dkr.ecr.us-east-1.amazonaws.com"
        REPO_NAME = "microservices-demo/frontend"
        GITHUB_REPO = "https://github.com/Amaldeep98/microservice-helm-charts.git"
        CHART_DIR = "helm-charts/frontend"
    }
                ...
                script {
                    env.LATEST_TAG = sh(
                        script: '''
                            ...
                            TAG_JSON=$(curl -s https://us-central1-docker.pkg.dev/v2/google-samples/microservices-demo/frontend/tags/list)
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'github-token', usernameVariable: 'GIT_USER', passwordVariable: 'GIT_TOKEN')]) {
                    sh '''
                        ...
                        git commit -m "Update frontend Helm chart to $LATEST_TAG" || echo "No changes to commit"
